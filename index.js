...
client.on('message', message => {
    ...
    switch(args[0]) {
        ...
        case 'kick':
            ...
            message.guild.member(kUser).send(`> You were kicked from ${client.guilds.get('573082577288822805').name} with reason: ${kReason} Kicked by: ${message.author.username} with ID ${message.author.id}`)
        break;
        case 'ban':
            if (!message.content.startsWith(PREFIX)) return
